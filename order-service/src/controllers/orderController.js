...
//         const customerIdFromHeader = req.headers['x-user-id'];
//         if(customerID != customerIdFromHeader)
...
const createOrder = async (req, res, next) => {
    try {
        ...
        // 2. Lấy các thông tin khác từ body (Bỏ qua customerId từ body để tránh giả mạo)
